(function ($) {
    ...
    var $html = $('html');
    var $body = $('body');
    var slider = $('.machine-learning-hero'); // Assuming your slider has a class of 'slider'
    ...
    windows.on('scroll', function () {
        ...
        if (screenSize >= 320) {
            if (scroll < headerHeight) {
                ...
                slider.removeClass('mt-5'); // Remove 'mt-5' when header is not sticky
            } else {
                sticky.addClass('is-sticky');
                slider.addClass('mt-5'); // Add 'mt-5' when header is sticky
            }
        }
    });
